...
public class WallMasterSpawn : MonoBehaviour
{
    ...
    void spawnEm()
    {
        ...
        coral1.transform.parent = gameObject.transform.parent;
        coral2.transform.parent = gameObject.transform.parent;
        coral3.transform.parent = gameObject.transform.parent;
        coral4.transform.parent = gameObject.transform.parent;
    }
